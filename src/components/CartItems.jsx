                    ...
                    {addCartItem.map((item) =>(
                        <div key={item.id} className="bg-neutral-800 rounded-2xl overflow-hidden border border-neutral-700 hover:border-blue-400 transition-all duration-300 shadow-lg hover:shadow-blue-400/20">
                            ...
                            <div className="p-4">
                                ...
                                <button 
                                    className="mt-4 w-full text-white py-2 rounded-lg font-semibold shadow hover:bg-blue-500 focus:ring-2 focus:ring-blue-300 transition-all duration-150 bg-blue-600"
